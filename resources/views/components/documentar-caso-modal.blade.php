        ...
        <div class="p-8 space-y-8">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <div class="flex-grow">
                        <x-input type="text" name="id_caso" placeholder="ID del Caso (Ej: 1001)" class="w-full"
                            required />
                    </div>
                </div>
            ...
            <!-- Detalles del Caso -->
            <div x-data="{ entries: [{ piece: '', qty: 1 }] }">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                <div>
                                    ...
                                    <select name="id_pieza_soporte[]" x-model="entry.piece"
                                        ...
                                        <option value="No presentó falla / Equipo operativo">No presentó falla / Equipo
                                            operativo</option>
                                        ...
                                        <option value="Carcasa / Case">Carcasa / Case</option>
                                        <option value="Monitor / Pantalla">Monitor / Pantalla</option>
                                        <option value="Batería / Pila">Batería / Pila</option>
                                        ...
                                        <option value="Unidad óptica (CD/DVD)">Unidad óptica (CD/DVD)</option>
                                        <option value="Tarjeta inversora">Tarjeta inversora</option>
                                        <option value="Tarjeta de red">Tarjeta de red</option>
                                        <option value="Tarjeta RAID">Tarjeta RAID</option>
                                        <option value="Touchpad">Touchpad</option>
                                        <option value="Suite Ofimatica">Suite Ofimatica</option>
                                        <option value="Ajuste de pantalla">Ajuste de pantalla</option>
                                        <option value="Bisagras">Bisagras</option>
                                        <option value="Fuente de poder">Fuente de poder</option>
                                        <option value="Módulo de encendido">Módulo de encendido</option>
                                        <option value="Pila de BIOS">Pila de BIOS</option>
                                        <option value="Disipador">Disipador</option>
                                        <option value="Ajuste de componentes">Ajuste de componentes</option>
                                        <option value="Sin reparar / Fuera de garantía">Sin reparar / Fuera de garantía
                                        </option>
                                    </select>
                                </div>
                                <div>
                                    <x-label value="Cantidad" class="mb-1 text-xs" />
                                    <x-input type="number" name="cantidad[]" x-model="entry.qty" placeholder="Cantidad"
